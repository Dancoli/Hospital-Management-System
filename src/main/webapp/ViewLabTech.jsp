...
ResultSet rs=null;
con.getCon();
String getEmployees="SELECT * FROM person WHERE role='LabTech'";
...
<td><%=email %></td>
<td><%=gender %></td>
<td><a href="delete.jsp?deleteId=<%=personId %>"class="btn"style="background-color: #81bc00;color: white;">Delete</a></td>
</tr>
<% } %>
</table>
